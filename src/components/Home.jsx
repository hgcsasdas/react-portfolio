      ...
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <p className="py-4 ">
            ...
            Application Development (DAM) and Web Application Development (DAW).
            My academic journey has instilled in me a solid foundation in
            software development. Eager to contribute my skills to dynamic
